...
```text
C:\Github Repo's\PSOBB\PSOBB-Runtime\archives\graphics-lab\local-assets\AshenbubsHD-PSOBB-v1.02-cfe0fd18.zip
...
pwsh -NoLogo -NoProfile -ExecutionPolicy Bypass `
  ...
  -Action Install `
  -Pack Characters `
  -ArchivePath "C:\Github Repo's\PSOBB\PSOBB-Runtime\archives\graphics-lab\local-assets\AshenbubsHD-PSOBB-v1.02-cfe0fd18.zip"
```
